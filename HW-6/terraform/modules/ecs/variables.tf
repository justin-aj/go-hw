...
variable "cpu" {
  type        = string
  default     = "256"
  description = "vCPU units (256 = 0.25 vCPU as required by Part II)"
}

variable "memory" {
  type        = string
  default     = "512"
  description = "Memory in MiB (512 MB as required by Part II)"
}

variable "target_group_arn" {
  type        = string
  default     = ""
  description = "ALB target group ARN. Empty string = no ALB attachment."
}
